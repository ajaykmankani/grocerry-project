...
<!-- Mirrored from preetheme.com/html/fodo/index2.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 18 Jun 2022 10:15:05 GMT -->
<head>
	<meta charset="UTF-8">
...
<body>
	...
	<section class="hero-area">
		<div class="hero-slider-full owl-carousel">
			<!-- single -->
			<div class="hs_item_single" style="background-image:url('assets/img/slider1.jpg');">
				<div class="container">
					<div class="row">
						<div class="col-lg-6">
			...
			<!-- single -->
			<div class="hs_item_single text-right" style="background-image:url('assets/img/slider2.jpg');">
				<div class="container">
					<div class="row">
						<div class="offset-lg-6 col-lg-6">
							...
							<a class="button-1" href="shop.html"><i class="bi bi-arrow-left"></i> Shop Now</a>
						</div>
					</div>
				</div>
			</div>
...
<!-- Mirrored from preetheme.com/html/fodo/index2.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 18 Jun 2022 10:15:06 GMT -->
</html>