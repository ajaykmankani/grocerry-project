...
<!-- Mirrored from preetheme.com/html/fodo/ by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 18 Jun 2022 10:14:31 GMT -->
<head>
	<meta charset="UTF-8">
	<meta name="viewport" content="width=device-width, initial-scale=1.0">
	<meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
	<title>Fodo - Grocery Store and Food eCommerce HTML5 Template</title>
...
<body>
	...
	<header class="header">
				...
				<div class="row">
					...
					<div class="col-lg-6">
						<div class="hl_top-left">
							<span><i class="bi bi-envelope"></i> info12@example.com</span>
							<span><i class="bi bi-geo-alt"></i> California, TX 70240</span>
						</div>
					</div>
					<!-- Top Right -->
					<div class="col-lg-6">
						...
						<div class="language-top">
							<span>English <i class="bi bi-arrow-down"></i></span>
							<ul>
						...
						<div class="top-social">
							...
							<span><a href="#" title="Vimeo"><i class="fab fa-vimeo-v"></i></a></span>
						</div>
					</div>
				</div>
			</div>
		...
		<!-- Header Bottom -->
		<div class="header-bottom sticky-header bg-white">
			<div class="container">
				<div class="row">
					...
					<div class="col-lg-10 col-md-8">
						...
						<div class="header-bright">
							...
							<!-- Cart Icon -->
							<div class="mini-cart-icon" title="Cart">
								<a href="#">
							...
							<!-- Cart Icon -->
							<div class="wishlist-cart-icon" title="Wishlist">
	...
	<section class="hero-area hero_container pt-30 pb-30">
		<div class="container">
			<div class="row">
				<div class="col-lg-3">
					<div class="fodo_category_menu h-100">
						<div class="ltn__category-menu-title">
                            <h2>all categories</h2>
                        </div>
                        <div class="ltn__category_list">
                        	<ul>
                        		<li class="cate_drop cate_mega"><a href="#">Vegetables and Fruits </a>
	                        		<ul class="sub-menu-cate mega-menu-cate">
                        				<li><a class="headding" href="#">Satchels </a>
                        					<ul>
                        				...
                        				<li><a  class="headding" href="#">Fresh Meat </a>
                        					<ul>
                        						<li><a href="#">Satchels</a></li>
                        						<li><a href="#">Satchels</a></li>
                        						<li><a href="#">Satchels</a></li>
                        				...
                        				<li><a class="headding" href="#">Seafood </a>
                        					<ul>
                        						<li><a href="#">Satchels</a></li>
                        						<li><a href="#">Satchels</a></li>
                        						<li><a href="#">Satchels</a></li>
                        		...
                        		<li class="cate_drop cate_mega"><a href="#">Fruits </a>
	                        		<ul class="sub-menu-cate mega-menu-cate">
                        				<li><a class="headding" href="#">Satchels </a>
                        					<ul>
                        						<li><a href="#">Satchels</a></li>
                        		...
                        		<li class="cate_drop cate_mega"><a href="#">Oil and Vinegar </a>
	                        		<ul class="sub-menu-cate mega-menu-cate w-500">
                        				<li><a class="headding" href="#">Satchels </a>
                        					<ul>
                        						<li><a href="#">Satchels</a></li>
                        						<li><a href="#">Satchels</a></li>
                        		...
                        		<li class="cate_drop"><a href="#">Apple Juice</a>
	                        		<ul class="sub-menu-cate">
                        				<li class="cate_drop"><a href="#">Satchels </a>
                        					<ul>
                        						<li><a href="#">Satchels</a></li>
                        						<li><a href="#">Satchels</a></li>
                        						<li><a href="#">Satchels</a></li>
                        				...
                        				<li><a href="#">Satchels </a>
                        				<li><a href="#">Satchels </a>
                        				<li><a href="#">Satchels </a>
	                        		</ul>
	                        	</li>
                        		<li class="cate_drop"><a href="#">Ocean Food</a>
                        			<ul class="sub-menu-cate">
                        		...
                        		<li class="cate_drop"><a href="#">Butter & Eggs</a>
									<ul class="sub-menu-cate">
                        				<li><a href="#">Cross Body</a></li>
                        				<li><a href="#">Satchels</a></li>
                        				<li><a href="#">Sholuder</a></li>
				...
				<div class="col-lg-9">
					<div class="hero-slider-full2 owl-carousel">
						<!-- single -->
						<div class="hs_item_single2" style="background-image:url('assets/img/slider3.jpg');">
							<div class="container">
								<div class="row">
									<div class="col-lg-6">
										...
										<a class="button-1" href="shop.html">Shop Now <i class="bi bi-arrow-right"></i></a>
									</div>
								</div>
							</div>
						</div>
						<!-- single -->
						<div class="hs_item_single2" style="background-image:url('assets/img/slider4.jpg');">
							<div class="container">
								<div class="row">
									<div class="col-lg-6">
										<h2>Fresh Food & Healthly Organic Food</h2>
						...
						<!-- single -->
						<div class="hs_item_single2" style="background-image:url('assets/img/slider5.jpg');">
							<div class="container">
								<div class="row">
									<div class="col-lg-6">
										<h2>Fresh Food & Healthly Organic Food</h2>
				...
				<div class="col-lg-3 col-md-4 col-sm-6 mb-30">
					<div class="product-item">
						...
						<div class="product-thumbnail">
							<div class="img">
								<a href="product-details.html">
									<img src="assets/img/product/6.png" alt="product">
								</a>
							</div>
							<a class="wishlist" href="wishlist.html"><i class="far fa-heart"></i></a>
							<div class="product-overly-btn">
				...
				<div class="col-lg-3 col-md-4 col-sm-6 mb-30">
					<div class="product-item">
						...
						<div class="product-thumbnail">
							<div class="img">
								<a href="product-details.html">
									<img src="assets/img/product/8.png" alt="product">
								</a>
							</div>
							<a class="wishlist" href="wishlist.html"><i class="far fa-heart"></i></a>
							<div class="product-overly-btn">
								...
								<div class="row">
									...
									<div class="col-md-7 align-self-center">
										<div class="content">
											...
											<h2><a href="product-details.html">Goodday Fresh Pasteur Milk 2 Liter </a></h2>
											<div class="pricing">
												<span>$200 <del>$210</del></span>
											</div>
											<div class="ratting">
				...
				<div class="row">
					<div class="offset-lg-6 offset-md-4 col-md-8 col-lg-6">
						<div class="banner-section-1-content">
							...
							<a class="button-1 button-round" href="shop.html">Shop Now <i class="bi bi-arrow-right"></i></a>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="row">
				...
				<div class="col-lg-3 col-sm-6 mb-30">
					<div class="banner_2_s h-100" style="background-image:url('assets/img/banner2.jpg');">
						...
						<a href="shop.html" class="button-1 button-round bg-white">Shop Now  <i class="bi bi-arrow-right"></i></a>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="footer-bottom pt-30 pb-10">
			<div class="container">
				<div class="row">
					...
					<div class="col-md-6 mb-20">
						<div class="f_caopy_text text-right">
							<p>Copyright © 2021 Fodo Theme by <a href="#"><b>CodexUnicTheme</b></a></p>
						</div>
					</div>
				</div>
			</div>
	...
	<div class="modal fade" id="QuickViewModal" tabindex="-1" aria-labelledby="QuickViewModal" aria-hidden="true">
	  	<div class="modal-dialog fd_qickView_screen">
	        		...
	        		<div class="row">
	        			...
	        			<div class="col-lg-6">
	        				<div class="p_details_content">
								...
								<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam ac dui sed nunc sagittis maximus. Sed lobortis commodo dapibus. Nunc placerat, massa nec blandit egestas...</p>
								<div class="pricing">
									<span>$200 <del>$210</del></span>
								</div>
								<div class="cate">
...
<!-- Mirrored from preetheme.com/html/fodo/ by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 18 Jun 2022 10:14:55 GMT -->
</html>