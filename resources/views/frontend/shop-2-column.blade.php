...
<!-- Mirrored from preetheme.com/html/fodo/shop-2-column.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 18 Jun 2022 10:15:10 GMT -->
<head>
	<meta charset="UTF-8">
...
<body>
	...
	<section class="breadcrumb-area pt-80 pb-80" style="background-image:url('assets/img/breadcrumb.jpg');">
		<div class="container">
			<div class="row">
				<div class="col-md-6">
					<h2>Shop 2 Columns</h2>
				</div>
				<div class="col-md-6 align-self-center">
					<ul class="text-right">
						<li><a href="index-2.html">Home</a></li>
						<li>Shop 2 Columns</li>
					</ul>
				</div>
			</div>
		</div>
