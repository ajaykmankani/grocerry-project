...
<!-- Mirrored from preetheme.com/html/fodo/forget-password.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 18 Jun 2022 10:15:10 GMT -->
<head>
	<meta charset="UTF-8">
...
<body>
	...
	<section class="pt-50 pb-50 section-bg-23">
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
					<div class="login-form-bhouse">
	        			...
	        			<div class="login-register-form-middle">
	        				<form action="#">
	        					<div class="single-input">
	        						<label for="rusername">Mail or UserName</label>
	        			...
	        			<div class="login-register-from-btom text-center">
	        				<p class="text-dark mb-0"> Forget it, <a href="contact.html" class="text-primary ml-1">send me back </a>  to the sign in. </p>
	        			</div>
	        		</div>
				</div>
			</div>
